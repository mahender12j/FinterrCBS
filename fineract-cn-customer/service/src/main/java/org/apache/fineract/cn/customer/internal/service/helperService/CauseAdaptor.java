...
public class CauseAdaptor {
    ...
    private final CAdminCauseManager cAdminCauseManager;

    @Autowired
    public CauseAdaptor(@Qualifier(ServiceConstants.LOGGER_NAME) final Logger logger,
                        final CAdminCauseManager cAdminCauseManager) {
        super();
        this.logger = logger;
        this.cAdminCauseManager = cAdminCauseManager;
    }
