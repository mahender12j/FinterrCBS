...
import org.apache.fineract.cn.customer.internal.command.CreateAmlDetailCommand;
...
import org.apache.fineract.cn.customer.internal.mapper.AmlDetailMapper;
...
import org.apache.fineract.cn.customer.internal.repository.AmlDetailRepository;
...
public class CustomerAggregate {
  ...
  private final AmlDetailRepository amlDetailRepository;
  ...
  public CustomerAggregate(final AddressRepository addressRepository,
    ...
    this.amlDetailRepository = amlDetailRepository;
  }
  ...
  public String createCustomer(final CreateCustomerCommand createCustomerCommand) {
    System.out.println(" createCustomer Start ----");
...
System.out.println("savedAddress  : "+ savedAddress );
    ...
    System.out.println(" CustomValues : "+customer.getCustomValues());
    ...
    System.out.println("customer.getIdentifier():  " +customer.getIdentifier());
  ...
  @Transactional
  @CommandHandler
  @EventEmitter(selectorName = CustomerEventConstants.SELECTOR_NAME, selectorValue = CustomerEventConstants.POST_AMLDETAILS)
  public String createAmlDetail(final CreateAmlDetailCommand createAmlDetailCommand) {
    final CustomerEntity customerEntity = findCustomerEntityOrThrow(createAmlDetailCommand.getCustomerIdentifier());

    final AmlDetailEntity amlDetailEntity = AmlDetailMapper.map(createAmlDetailCommand.getAmlDetail());
    System.out.print("AmlDetailEntity - Status :: " + amlDetailEntity.getStatus());
    amlDetailEntity.setCustomer(customerEntity);
    amlDetailEntity.setCreatedBy(UserContextHolder.checkedGetUser());
    amlDetailEntity.setCreatedOn(LocalDateTime.now(Clock.systemUTC()));

    this.amlDetailRepository.save(amlDetailEntity);


    return amlDetailEntity.getStatus();
  }
}
