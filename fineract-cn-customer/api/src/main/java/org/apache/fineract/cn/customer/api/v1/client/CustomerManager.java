...
public interface CustomerManager {
  ...
  @ThrowsExceptions({
      @ThrowsException(status = HttpStatus.NOT_FOUND, exception = CustomerNotFoundException.class),
      @ThrowsException(status = HttpStatus.BAD_REQUEST, exception = AmlDetailValidationException.class)
  })
  void postAmlDetail(@PathVariable("identifier") final String identifier, @RequestBody final AmlDetail amlDetail);
}
