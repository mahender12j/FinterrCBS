...
public final class NGOStatistics {
    ...
    public int getTotalCause() {
        return totalCause;
    }

    public void setTotalCause(int totalCause) {
        this.totalCause = totalCause;
    }
