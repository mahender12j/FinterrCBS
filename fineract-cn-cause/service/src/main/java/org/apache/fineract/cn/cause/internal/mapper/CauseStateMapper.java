...
public final class CauseStateMapper {

    private CauseStateMapper() {
        super();
    }

    public static CauseState map(final CauseStateEntity causeStateEntity) {
        CauseState causeState = new CauseState();
        causeState.setCreatedBy(causeStateEntity.getCreatedBy());
