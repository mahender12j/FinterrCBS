...
import org.apache.fineract.cn.cause.internal.command.InitializeServiceCommand;
...
public class MigrationAggregate {
    ...
    @CommandHandler
    @EventEmitter(selectorName = CauseEventConstants.SELECTOR_NAME, selectorValue = CauseEventConstants.INITIALIZE)
    public String initialize(final InitializeServiceCommand initializeServiceCommand) {
        ...
        return CauseEventConstants.INITIALIZE;
    }
}