...
public interface DocumentRepository extends JpaRepository<DocumentEntity, Long> {
    ...
    @Query("SELECT d FROM DocumentEntity d WHERE d.cause.identifier = :causeIdentifier AND d.identifier = :documentIdentifier")
    Optional<DocumentEntity> findByCauseIdAndDocumentIdentifier(
