...
import org.apache.fineract.cn.cause.api.v1.domain.TaskInstance;
...
import org.apache.fineract.cn.cause.internal.repository.TaskInstanceEntity;
...
public class TaskInstanceMapper {
    ...
    public static TaskInstanceEntity create(final TaskDefinitionEntity taskDefinition, final CauseEntity cause) {
        final TaskInstanceEntity taskInstanceEntity = new TaskInstanceEntity();
        taskInstanceEntity.setTaskDefinition(taskDefinition);
        taskInstanceEntity.setCause(cause);
