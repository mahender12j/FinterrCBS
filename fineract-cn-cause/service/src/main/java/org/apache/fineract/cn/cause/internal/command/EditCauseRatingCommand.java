...
public class EditCauseRatingCommand {

    private final String causeIdentifier;
    private final Long ratingId;
    private final CauseRating causeRating;

    public EditCauseRatingCommand(final String causeIdentifier,
                                  final Long ratingId,
                                  final CauseRating causeRating) {
        super();
