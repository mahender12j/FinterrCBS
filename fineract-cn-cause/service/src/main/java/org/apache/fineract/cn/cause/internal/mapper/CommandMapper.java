...
import org.apache.fineract.cn.cause.internal.repository.CommandEntity;
...
public final class CommandMapper {
    ...
    public static CommandEntity create(final CauseEntity cause, final String action, final String comment) {
        final CommandEntity commandEntity = new CommandEntity();
        commandEntity.setCause(cause);
