...
public class CreateCauseUpdateInfoCommand {

    private final String identifier;
    private final CauseUpdateInfo causeUpdateInfo;

    public CreateCauseUpdateInfoCommand(final String identifier, final CauseUpdateInfo causeUpdateInfo) {
        super();
